...
export const COOKING_RECIPES: CookingRecipe[] = [
  ...
  { name: "토마토 파인애플 피자", bases: { tomato: 2, onion: 0, garlic: 1 }, minPrice: 922, maxPrice: 3077, img: "food_tomato_pineapple_pizza.png", ingredients: "토마토 베이스 2개 + 마늘 베이스 1개 + 파인애플 1개 + 치즈 조각 1개 + 스테이크 1개 + 익힌 소 등심 1개" },
...
// 기존 코드 호환성을 위한 별칭
export const EFFICIENCY_RECIPES = COOKING_RECIPES
