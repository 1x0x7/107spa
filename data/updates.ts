...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 47334,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 41019,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 9850,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 114353,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 380648,        // 자개 부채 (0 ~ 700,000)
  watch: 292118,      // 흑진주 시계 (0 ~ 1,000,000)
}
