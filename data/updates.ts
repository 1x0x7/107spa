...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 4420,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 72202,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 145790,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 47908,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 306619,        // 자개 부채 (0 ~ 700,000)
  watch: 665587,      // 흑진주 시계 (0 ~ 1,000,000)
}
