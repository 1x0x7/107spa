...
export const PRICE_DATES = {
  // 요리 가격 (3일마다 수정)
  cooking: "04.15 ~ 04.18 기준",
  
  // 시스템 시세
  system: "04.14 01:00 기준",
  enchant: "04.14 01:00기준",   // 라이프스톤
  engrave: "04.14 01:00 기준",   // 영혼 계약서
  
  // 공예품 시세 (매일 수정)
  craft: "04.15 03:00 기준",
}
...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 48409,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 19048,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 179675,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 449606,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 144048,        // 자개 부채 (0 ~ 700,000)
  watch: 653685,      // 흑진주 시계 (0 ~ 1,000,000)
}
