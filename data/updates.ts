...
export const PRICE_DATES = {
  // 요리 가격 (3일마다 수정)
  cooking: "03.24 ~ 03.27 기준",
  
  // 시스템 시세
  system: "03.24 12:00 기준",
  enchant: "03.24 12:00기준",   // 라이프스톤
  engrave: "03.24 12:00 기준",   // 영혼 계약서
  
  // 공예품 시세 (매일 수정)
  craft: "03.28 03:00 기준",
}
...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 36786,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 49172,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 230842,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 240333,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 279598,        // 자개 부채 (0 ~ 700,000)
  watch: 410322,      // 흑진주 시계 (0 ~ 1,000,000)
}
