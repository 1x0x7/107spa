...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 41705,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 638,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 114195,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 476209,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 483124,        // 자개 부채 (0 ~ 700,000)
  watch: 199053,      // 흑진주 시계 (0 ~ 1,000,000)
}
