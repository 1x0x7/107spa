...
export const PRICE_DATES = {
  ...
  // 시스템 시세
  system: "04.09 08:00 기준",
  enchant: "04.09 08:00기준",   // 라이프스톤
  engrave: "04.09 08:00 기준",   // 영혼 계약서
  
  // 공예품 시세 (매일 수정)
  craft: "04.09 03:00 기준",
}
...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 40169,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 125233,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 24379,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 183050,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 694990,        // 자개 부채 (0 ~ 700,000)
  watch: 300363,      // 흑진주 시계 (0 ~ 1,000,000)
}
