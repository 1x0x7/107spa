...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 12684,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 74051,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 295466,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 263342,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 341425,        // 자개 부채 (0 ~ 700,000)
  watch: 121753,      // 흑진주 시계 (0 ~ 1,000,000)
}
