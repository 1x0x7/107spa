...
export const PRICE_DATES = {
  // 요리 가격 (3일마다 수정)
  cooking: "04.24 ~ 04.27 기준",
  
  // 시스템 시세
  system: "04.26 20:00 기준",
  enchant: "04.26 20:00기준",   // 라이프스톤
  engrave: "04.26 20:00 기준",   // 영혼 계약서
  
  // 공예품 시세 (매일 수정)
  craft: "04.26 03:00 기준",
}
...
export const CRAFT_PRICES: Record<string, number> = {
  brooch: 40866,      // 조개껍데기 브로치 (0 ~ 50,000)
  perfume: 38470,    // 푸른 향수병 (0 ~ 150,000)
  mirror: 256067,     // 자개 손거울 (0 ~ 300,000)
  hairpin: 94192,    // 분홍 헤어핀 (0 ~ 500,000)
  fan: 193382,        // 자개 부채 (0 ~ 700,000)
  watch: 622318,      // 흑진주 시계 (0 ~ 1,000,000)
}
...
export const UPDATE_HISTORY: UpdateItem[] = [
  {title: "요리 및 공예품 가격 변동", 
    desc: "트리플 소갈비 꼬치 > 달콤 시리얼 > 스윗 치킨 햄버거", 
    date: "2025.04.24", 
    isLatest: true,
    details: {
    ...
    {title: "요리 및 공예품 가격 변동", 
    desc: "트리플 소갈비 꼬치 > 스윗 치킨 햄버거 > 로스트 치킨 파이", 
    date: "2025.04.21", 
    details: {
    ...
    {title: "요리 및 공예품 가격 변동", 
    desc: "마늘 양갈비 핫도그 > 삼색 아이스크림 > 달콤 시리얼", 
    date: "2025.04.18", 
    isLatest: true,
    details: {
    }
